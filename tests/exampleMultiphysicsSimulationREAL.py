...
nonfluxid = 2
bc_nonflux_mat1 = volume.CreateBC(volume, nonfluxid,N_Type,val1,val2)
cfluxmesh.InsertMaterialObject(bc_nonflux_mat1)
nonfluxid = 3
bc_nonflux_mat2 = volume.CreateBC(volume, nonfluxid,N_Type,val1,val2)
cfluxmesh.InsertMaterialObject(bc_nonflux_mat2)
nonfluxid = 4
bc_nonflux_mat3 = volume.CreateBC(volume, nonfluxid,N_Type,val1,val2)
cfluxmesh.InsertMaterialObject(bc_nonflux_mat3)
...
multcmesh.InsertMaterialObject(bc_nonflux_mat1)
multcmesh.InsertMaterialObject(bc_nonflux_mat2)
multcmesh.InsertMaterialObject(bc_nonflux_mat3)
...
val2 = TPZFMatrix(1,1,0.0)
nonfluxid=2
bc_nonflux_mat1 = voltransport.CreateBC(voltransport, nonfluxid,typ,val1,val2)
ctransportmesh.InsertMaterialObject(bc_nonflux_mat1)
nonfluxid=3
bc_nonflux_mat2 = voltransport.CreateBC(voltransport, nonfluxid,typ,val1,val2)
ctransportmesh.InsertMaterialObject(bc_nonflux_mat2)
nonfluxid=4
bc_nonflux_mat3 = voltransport.CreateBC(voltransport, nonfluxid,typ,val1,val2)
ctransportmesh.InsertMaterialObject(bc_nonflux_mat3)
...
nonfluxid = 2
bc_1 =voltrans.CreateBC(voltrans, nonfluxid, type_inlet, val1,val2)
multtransportcmesh.InsertMaterialObject(bc_1)
nonfluxid = 3
bc_2 =voltrans.CreateBC(voltrans, nonfluxid, type_inlet, val1,val2)
multtransportcmesh.InsertMaterialObject(bc_2)
nonfluxid = 4
bc_3 =voltrans.CreateBC(voltrans, nonfluxid, type_inlet, val1,val2)
multtransportcmesh.InsertMaterialObject(bc_3)
val2 = TPZFMatrix(1,1,1.0)
bc_4 =voltrans.CreateBC(voltrans, 5, type_inlet, val1,val2)
multtransportcmesh.InsertMaterialObject(bc_4)

val2 = TPZFMatrix(1,1,0.0)
bc_5 =voltrans.CreateBC(voltrans, 6, type_outlet, val1,val2)
multtransportcmesh.InsertMaterialObject(bc_5)
...
while count < n_steps:
    ...
    an_transp.DefineGraphMesh(dim,scalnames,vecnames, name)
    an_transp.PostProcess(0,dim)
